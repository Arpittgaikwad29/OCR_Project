...
def agent_final_output():
    ...
    with st.spinner("Generating final medical response..."):
        try:
            ...
            4. chronological order visite of the pateint,
            Patient Data:
            {patient_data}
            ...
            Your response should be formatted with clear sections for Summary, Prescription, and Recommendations , chronological order visite of the pateint.
            """
    ...
    if uploaded_file is not None:
        ...
        if st.button("Process Document"):
            with st.container():
                ...
                understood_text = agent_understanding(extracted_text)
